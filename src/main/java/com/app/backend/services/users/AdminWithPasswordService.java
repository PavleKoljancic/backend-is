...
import com.app.backend.repositories.users.AdminWithPasswordRepo;
...
public class AdminWithPasswordService implements UserDetailsService{
    ...
    public AdminWithPassword findByEmail(String email){

        return adminWithPasswordRepo.findByEmail(email);
    }
}
